...
{{-- scripts --}}
	<div class="container">
		<div role="application" class="panel panel-group">
			<div class="panel-default">
				<div class="panel-heading"><h4>Datos de la Sucursal:</h4>
					...
					<a class="btn btn-warning" href="{{ route('sucursales.edit',['sucursal'=>$sucursal->id]) }}"><strong>Editar</strong></a>
				</div>
		...
		<ul class="nav nav-pills ">
			<li class="active"><a data-toggle="tab" href="#dir" class="btn-info">Dirección</a></li>
			<li><a data-toggle="tab" href="#gas" class="btn-info">Gastos</a></li>
			<li><a data-toggle="tab" href="#emp" class="btn-info">Empleados</a></li>
  		</ul>
			...
			<div id="dir" class="tab-pane fade in active">
				<div role="application" class="panel panel-group">
					<div class="panel-default">
						...
						<div class="panel-heading"><h4>Dirección de Sucursal :</h4></div>
						<div class="panel-body">
