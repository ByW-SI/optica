			...
			@foreach($bancos as $banco)
				<tr class="active">
					...
					<td>
						<div class="row-8">
							<div class="col-sm-4">
								<a class="btn btn-info btn-sm" href="{{ route('bancos.edit',['banco'=>$banco]) }}"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><strong> Editar</strong></a>
						...
						<a type="submit" onclick="deleteFunction('eliminar {{ $banco->id }}')" class="btn btn-info btn-sm" ><i class="fa fa-trash" aria-hidden="true"></i><strong> Borrar</strong></a>
						</form>
				</tr>
					</td>
				</tbody>
