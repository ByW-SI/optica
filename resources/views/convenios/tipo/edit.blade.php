				...
				<form role="form" name="conv" id="conv" method="POST" action="{{ route('convenios.tipoconvenios.update',['convenio'=>$convenio,'tipoconvenio'=>$tipoconvenio]) }}"> {{-- por agregar información --}}
					...
					<div class="row">
						<div class="form-group col-sm-3">
							...
							<input class="form-control" type="number" step="1" min="1" name="num_tramites" required value="{{ $tipoconvenio->num_tramites }}">
						</div>
						<div class="form-group col-sm-3">
					...
					<div class="row">
						...
						<div class="form-group col-sm-3">
							...
							<div class="input-group">
								<span class="input-group-addon">#</span><input type="number" class="form-control" id="num_cita" name="num_cita" value="{{$tipoconvenio->num_cita}}">
							</div>
						</div>
						<div class="form-group col-sm-6">
