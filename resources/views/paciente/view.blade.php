					...
					<div class="col-sm-7">
						<div class="row">
							<div class="col-sm-12">
									<div class="col-sm-8">
										<div class="form-group">
											<label for="donde" class="col-sm-6 control-label" style="margin-top: 10px;">¿De dónde viene?</label>
											<div class="col-sm-10">
											...
											<div class="thumbnail" style="margin-top: 10px; margin-bottom: 0px;">
												<img id="imagenpre" src="https://upmaa-pennmuseum.netdna-ssl.com/collections/images/image_not_available_300.jpg" alt="Previa..." style="width: 100%; height: auto;">
										      	<div class="caption">
													...
													<input type="file" class="imagen" id="receta" onchange="previewFile(this)" style="display: none;">
